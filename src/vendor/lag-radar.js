/**
 * Vendored verbatim from https://github.com/mobz/lag-radar (Ben Birch / @mobz).
 * Used as the hero "active signals" sweep. Themed to the site palette via CSS
 * overrides in app.css — the module's own logic is left untouched.
 *
 * lagRadar
